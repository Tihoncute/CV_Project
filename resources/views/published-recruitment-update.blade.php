        ...
        <div class="container published-recuitment-content">
            <div class="row">
                <div class="col-md-8 col-sm-12 col-12 recuitment-inner">
                    <form class="recuitment-form" method="post" action="/infoVL/update/{{$vieclam->MaVL}}" >
                        @method('PATCH')
                        @csrf
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control"
                                                    placeholder="Nhập tiêu đề" name="Tieude" value="{{$vieclam->Tieude}}">
                                                    <input type="text" class="form-control"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="number" class="form-control"
                                                    placeholder="1" name="SoLuongTuyen" value="{{$vieclam->SoluongTuyen}}">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label
                                            ...
                                            <div class="col-sm-9">
                                                <select type="text" class="form-control"
                                                    ...
                                                    <option value="{{$vieclam->Gioitinh}}">{{$vieclam->Gioitinh}}</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea type="text" class="form-control"
                                                    ...
                                                    rows="5" name="Mota">{{$vieclam->Mota}}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label
                                            ...
                                            <div class="col-sm-9">
                                                <textarea type="text" class="form-control"
                                                    ...
                                                    rows="5" name="Yeucau">{{$vieclam->Yeucau}}</textarea>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-9">
                                                <select type="text" class="form-control"
                                                    ...
                                                    <option  value="">Chọn kinh
                                                        nghiệm</option>
                                                    <option value="{{$vieclam->Kinhngiem}}">{{$vieclam->Kinhngiem}}</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select type="text" class="form-control"
                                                    ...
                                                    <option  value="{{$vieclam->Mucluong}}">{{$vieclam->Mucluong}}</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select type="text" class="form-control"
                                                    ...
                                                    <option value="{{$vieclam->Nganhnghe}}">{{$vieclam->Nganhnghe}}</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <select type="text" class="form-control"
                                                    ...
                                                    <option value="{{$vieclam->Diachi}}">{{$vieclam->Diachi}}</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="date" class="form-control"
                                                    placeholder="Nhập nơi làm việc" name="Hannop" name="{{$vieclam->Hannop}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
